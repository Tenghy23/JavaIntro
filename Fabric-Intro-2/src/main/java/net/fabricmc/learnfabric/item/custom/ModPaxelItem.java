...
import net.fabricmc.learnfabric.item.custom.ModAxeItem;
import net.fabricmc.learnfabric.item.custom.ModHoeItem;
import net.fabricmc.learnfabric.item.custom.ModPickaxeItem;
